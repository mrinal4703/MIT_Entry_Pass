                ...
                <div align="center" class="row">
                    ...
                    <div align="center" class="card" style="margin-top: 50px; align-items: center; position: fixed; display: flex;border-radius: 10px;">
                        ...
                        <div class="card-body" style="margin-top: 100px; width: 450px;">
                            <br>
                            <form action="requestsent" method="post" id="form">
                                ...
                                <input type="text" name="f" class="form-input" placeholder="Address" id="address" required><br>
                                <input type="date" name="g" id="dateField" class="form-input" required hidden>
                                <input type="text" name="e" class="form-input" placeholder="Issuer" value="<%=(String) session.getAttribute("userName")%>" id="id" required hidden>
                                <%
                                    try{
                                    ...
                                    PreparedStatement stmt2 = con.prepareStatement("select * from members");
                                    ResultSet rs=stmt2.executeQuery();%>
                                    <input list="myOptions" id="faculty" class="form-control form-input" placeholder="Concerning faculty" name="d" required/><br>
                                <datalist id="myOptions" class="my-datalist">
                                    <%while(rs.next()){
                                    %><option value="<%=rs.getString("name")%>"><%=rs.getString("name")%> <%=rs.getString("designation")%></option><%
                                    }%>
                                </datalist>
<!--                                <input type="submit" value="   Send Request   " class="btn-primary btn"><br><br><br>-->
                                ...
                                <% boolean flag1 = false;
                                    ...
                                    if (loggedIn == null || !loggedIn) { %>
                                   <a class="btn-primary btn" href="#" onclick="alert('Please Login')">   Send Request   </a>
                                 <% } else { %>
                                   <input type="submit" value="   Send Request   " class="btn-primary btn"><br><br>
                                 <% } %>
                            </form>
                        </div>
                    </div>
